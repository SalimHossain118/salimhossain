...
const ClientReview = () => {
  ...
  return (
    <section className="w-full py-20 border-b-[1px] border-black">
      <div>
        ...
        <Slider {...settings}>
          <div className=" w-full ">
            <div className=" w-full h-[500px] flex justify-between">
              <div className="w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col justify-center gap-8 ">
                <img
              ...
              <div className="w-[68%] h-full flex flex-col justify-between">
                ...
                <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b]  rounded-lg shadow-shadowOne p-8 gap-8">
